...
export const env = {
  ...
  NEXT_PUBLIC_SUPABASE_ANON_KEY: getRequiredEnvVar(
  ...
  NEXT_PUBLIC_FIREBASE_MESSAGING_conversation_id: getEnvVar(
    "NEXT_PUBLIC_FIREBASE_MESSAGING_conversation_id",
  ),
...
export const firebaseConfig = {
  ...
  messagingSenderId: env.NEXT_PUBLIC_FIREBASE_MESSAGING_conversation_id,
