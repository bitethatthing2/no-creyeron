...
BEGIN
    SELECT json_agg(
        json_build_object(
            ...
            'content_comments_count', COALESCE(
                (SELECT COUNT(*) FROM content_comments wc 
