...
DROP POLICY IF EXISTS "Users can like wolfpack_videos" ON wolfpack_post_likes;
DROP POLICY IF EXISTS "Users can unlike wolfpack_videos" ON wolfpack_post_likes;
