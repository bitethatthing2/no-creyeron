...
CREATE TABLE IF NOT EXISTS user_notification_preferences (
  ...
  content_comments BOOLEAN DEFAULT true,
  follows BOOLEAN DEFAULT true,
  mentions BOOLEAN DEFAULT true,
  new_content_posts BOOLEAN DEFAULT true,
...
RETURNS TABLE (
  likes BOOLEAN,
  content_comments BOOLEAN,
  follows BOOLEAN,
  mentions BOOLEAN,
  new_content_posts BOOLEAN,
...
BEGIN
  ...
  IF NOT FOUND THEN
    ...
    SELECT 
      true::BOOLEAN,  -- likes
      true::BOOLEAN,  -- content_comments
      true::BOOLEAN,  -- follows
      true::BOOLEAN,  -- mentions
      true::BOOLEAN,  -- new_content_posts
...
CREATE OR REPLACE FUNCTION update_user_notification_preferences(
  ...
  new_content_comments BOOLEAN DEFAULT NULL,
  new_follows BOOLEAN DEFAULT NULL,
  new_mentions BOOLEAN DEFAULT NULL,
  new_new_content_posts BOOLEAN DEFAULT NULL,
...
BEGIN
  ...
  IF NOT preferences_exist THEN
    ...
    INSERT INTO user_notification_preferences (
      ...
      COALESCE(new_content_comments, true),
      COALESCE(new_follows, true),
      COALESCE(new_mentions, true),
      COALESCE(new_new_content_posts, true),
  ...
  ELSE
    ...
    UPDATE user_notification_preferences SET
      ...
      content_comments = COALESCE(new_content_comments, content_comments),
      follows = COALESCE(new_follows, follows),
      mentions = COALESCE(new_mentions, mentions),
      new_content_posts = COALESCE(new_new_content_posts, new_content_posts),
