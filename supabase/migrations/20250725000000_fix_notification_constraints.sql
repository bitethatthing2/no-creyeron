...
-- Create function to automatically create notifications for content_comments
...
BEGIN
  ...
  -- Don't notify if user content_comments on their own post
  IF video_owner_id != NEW.user_id THEN
    -- Create notification
    INSERT INTO wolfpack_activity_notifications (
      recipient_id,
...
DROP TRIGGER IF EXISTS create_comment_notification_trigger ON "public"."content_comments";  
