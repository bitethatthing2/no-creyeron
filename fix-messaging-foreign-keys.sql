...
ALTER TABLE wolfpack_conversation_participants 
ADD CONSTRAINT wolfpack_conversation_participants_user_id_fkey 
...
DROP POLICY IF EXISTS "Users can update conversations they participate in" ON wolfpack_conversations;
DROP POLICY IF EXISTS "Users can view participants in their conversations" ON wolfpack_conversation_participants;
DROP POLICY IF EXISTS "Users can join conversations" ON wolfpack_conversation_participants;
DROP POLICY IF EXISTS "Users can update their own participation" ON wolfpack_conversation_participants;
...
DROP POLICY IF EXISTS "Users can update their own messages" ON wolfpack_messages;
...
CREATE POLICY "Users can create conversations" ON wolfpack_conversations
